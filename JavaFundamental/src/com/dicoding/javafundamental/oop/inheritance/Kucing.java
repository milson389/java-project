package com.dicoding.javafundamental.oop.inheritance;
...
public class Kucing extends Hewan implements Mamalia {
    ...
    public void makan(){ // Overriding = mengubah isi
        System.out.println("Kucing sedang makan..");
    }

    public void makan(String food) { // overloading = menambah biasa @param beda
